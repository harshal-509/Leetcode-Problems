...
<ul>
	<li><code>1 &lt;= matches.length &lt;= 10<sup style="">5</sup></code></li>
	<li><code>matches[i].length == 2</code></li>
	<li><code>1 &lt;= winner<sub>i</sub>, loser<sub>i</sub> &lt;= 10<sup style="">5</sup></code></li>
