<h2><a href="https://leetcode.com/problems/maximum-count-of-positive-integer-and-negative-integer/">2529. Maximum Count of Positive Integer and Negative Integer</a></h2><h3>Easy</h3><hr><div data-read-aloud-multi-block="true"><p>Given an array <code>nums</code> sorted in <strong>non-decreasing</strong> order, return <em>the maximum between the number of positive integers and the number of negative integers.</em></p>
