<h2><a href="https://leetcode.com/problems/distinct-prime-factors-of-product-of-array/">2521. Distinct Prime Factors of Product of Array</a></h2><h3>Medium</h3><hr><div data-read-aloud-multi-block="true"><p>Given an array of positive integers <code>nums</code>, return <em>the number of <strong>distinct prime factors</strong> in the product of the elements of</em> <code>nums</code>.</p>
...
The product of all the elements in nums is: 2 * 4 * 3 * 7 * 10 * 6 = 10080 = 2<sup style="">5</sup> * 3<sup style="">2</sup> * 5 * 7.
...
<strong>Explanation:</strong>
The product of all the elements in nums is: 2 * 4 * 8 * 16 = 1024 = 2<sup style="">10</sup>.
