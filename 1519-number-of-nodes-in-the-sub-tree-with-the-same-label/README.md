...
<p>Return <em>an array of size <code>n</code></em> where <code>ans[i]</code> is the number of nodes in the subtree of the <code>i<sup style="">th</sup></code> node which have the same label as node <code>i</code>.</p>
